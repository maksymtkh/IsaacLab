...
from isaaclab_tasks.manager_based.manipulation.sort_maksym.config.ur_5e.sort_ik_rel_visuomotor_env_smallwa_cfg import (
...
class UR5eSortIKRelVisuomotorMimicEnvCfg(UR5eSortVisuomotorEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "isaac_lab_ur5e_sort_ik_rel_visuomotor_D0"
