...
from .sort_joint_pos_env_bigwa_cfg import EventCfg as EventSpecificCfg
from .sort_joint_pos_env_bigwa_cfg import UR5eSortEnvCfg as UR5eSortEnvSpecificCfg
...
class UR5eSortVisuomotorEnvCfg(UR5eSortEnvSpecificCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.wrist_cam = CameraCfg(
            ...
            height=600,
            width=800,
            data_types=["rgb"], # Param1, Param3, Param4
            #data_types=["rgb","distance_to_plane"], # Param2
