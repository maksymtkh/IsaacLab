...
from isaaclab_tasks.manager_based.manipulation.sort_maksym.sort_env_cfg import SortSmallWAEnvCfg as SortEnvCfg
...
INITIAL_POSE_NUTS = [(0.3, 0.57), (0.04, 0.43), (0.0, 0.0)] # (x, y, z) area to spawn the nuts
